 ...
 * an instrument with a proportional value. It can also show a selective range
 * to better display a relevant information.
 * 
...
public class RangeInstrument extends Instrument {
    ...
    public void setCurrent(int current) {
        ...
        if (getWarningStatus()) {
            System.out
                    .println("Instrument [WARNING " + super.getCurrent() + " breaches setpoint " + getWarning() + "]");
        }
    }
