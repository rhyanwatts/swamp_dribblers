...
/**
 * The Sensors provide data to the BikeSack system about the current physical state of the motorbike
 * These are currently manipulated via keyboard input, but could also be connected to real sensors
 */
public class Sensor {
	/**
	 * Controls the amount that the value of the sensor will change by when using the increase() or decrease() methods
	 */
	...
	/**
	 * @param min The minimum value the Sensor can read
	 * @param max The maximum value the Sensor can read
	 */
	 ...
	 * @param min The minimum value the Sensor can read
	 * @param max The maximum value the Sensor can read
	 * @param warning The value where a Sensor is above recommended operation
	 */
	 ...
	 * @param max The maximum value the Sensor can read
	 * @param warning The value where a Sensor is above recommended operation
	 * @param defaultValue The value a Sensor should return when the current value is not available (real world sensor failure)
	 */
	 ...
	 * @throws SensorException If new current value is outside Sensor min/max range
	 */
	...
	/**
	 * @return The value a Sensor should return when the current value is not available (real world sensor failure)
	 */
	 ...
	 * @throws SensorException If the value of the sensor is increased past the Sensor's maximum value
	 */
	 ...
	 * @throws SensorException If the value of the sensor is decreased past the Sensor's minimum value
	 */
