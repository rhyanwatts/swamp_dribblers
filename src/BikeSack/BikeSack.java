 ...
 * rider well informed. 
 * <p>System produced as a group project for RMIT CPT111 Building IT Systems [BITS]
 * SP2 2017.</p>
...
public class BikeSack {
   ...
   public void setSensors(String selection) throws SensorException {
      ...
      case ODOMETER_INCREASE_KEY:
         ...
         ;
         System.out
               .println("Sensor [Type= ODOMETER, State= " + sensors.get(CONNECTED_SENSORS.ODOMETER).getCurrent() + "]");
         break;
