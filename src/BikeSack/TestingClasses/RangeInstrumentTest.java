...
public class RangeInstrumentTest {
   ...
   public static void main(String[] args) {
    ...
    //Test with Unit Values - Example is Fuel
      ...
      System.out.println("Percent = " + instrument1.getPercent());
      System.out.println("PercentString = " + instrument1.getPercentString());
      ...
      System.out.println("Percent = " + instrument2.getPercent());
      System.out.println("PercentString = " + instrument2.getPercentString());
      ...
      System.out.println("Percent = " + instrument3.getPercent());
      System.out.println("PercentString = " + instrument3.getPercentString());
