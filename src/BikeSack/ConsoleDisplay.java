...
public class ConsoleDisplay extends Display {
	 ...
	 * 
	 * @param instruments
	 *            Map of all instruments in the BikeSack system that require
	 *            display for the rider's information.
	 * @see INSTRUMENTS
	 * @see Instrument
	 */
	public void show(Map<INSTRUMENTS, Instrument> instruments) {
		...
		// Section - Print Instruments and Gauges
		...
		// Section - Print Gui User Controls
		System.out.println("+" + String.format("%68s", "").replace(' ', '-') + "+");
		...
		System.out.println("|" + pad("G= Full Graphical Display", 46) + pad("|", 23));
	...
	/**
	 * Right Pads a string with supplied number of spaces.
	 * 
	 * @param text
	 *            String of text that is to be padded.
	 * @param chars
	 *            Int number of characters pad the string with.
	 * @return A string of text that is padded with spaces.
	 */
	...
	/**
	 * Visually displays the fade IN/OUT of the indicator based on the value of
	 * the instrument.
	 * 
	 * @param indicator
	 *            Instrument indicator that is to to output to the GUI.
	 * @return String representation of the indicator value in "*".
	 */
