...
/**
 * <h1>Bike Sack HeadlightInstrument Class</h1> The Headlight Instrument Class
 * extends BikeSack's 'Instrument'
 * 
 * This class allows for an instrument with a Boolean value with status of low
 * and high.
 * 
...
public class HeadlightInstrument extends BooleanInstrument {
    ...
    /**
     * Return a string to represent the current value of the HeadlightInstrument Low
     * when current = 0 High when current = 1
     */
    @Override
